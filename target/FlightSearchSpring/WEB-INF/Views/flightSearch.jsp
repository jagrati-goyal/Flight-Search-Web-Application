...
<body>
	<div class="bg container">
		<a href="/logout" onclick=" if(!confirm('Do you really want to logout?'))event.preventDefault();">logout</a>
		<div class="row">
			<h1 style="text-decoration: underline;" align="center">Welcome to Flight
				Search Application</h1>
			<br />
			<div align="center">
	...
	<div class="col-md-11">
		<table class="table tablebg table-bordered">
			...
			<tr>
				...
				<td colspan="9">
						<span style="font-weight: bold;"> <%=Constants.NO_FLIGHTS%></span>
						</td>
					</c:if>
			</tr>
			<tbody>
